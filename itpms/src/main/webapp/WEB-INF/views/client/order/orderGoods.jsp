                                   ...
                                   <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                         <div class="checkout__form__input">
	                                        ...
	                                        <input type="text" class="form-control mb-3" name="roadAddress" id="roadAddress" value="${orderer.roadAddress }">
                                    	</div>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="checkout__form__input">
	                                        <label for="jibunAddress">지번 주소 <span>*</span></label>
	                                        <input type="text" class="form-control" name="jibunAddress" id="jibunAddress" value="${orderer.jibunAddress }">
                                    	</div>
                                    </div>
                                    <div class="col-12 mb-3">
                                    	<div class="checkout__form__input">
	                                        <label for="restAddress">나머지 주소 <span>*</span></label>
	                                        <input type="text" class="form-control" name="restAddress" id="restAddress" value="${orderer.restAddress }">
                                    	</div>
                                    </div>
                                    <div class="col-12">
                                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>상품명 | 수량</span> <span>${goodsDto.goodsNm } | ${orderGoodsQty }개</span></li>
                                <li><span>상품가격</span> <span><fmt:formatNumber value="${(goodsDto.price - (goodsDto.price * goodsDto.discountRate / 100)) * orderGoodsQty}"/>원</span></li>
                                <li><span>배송비</span> <span><fmt:formatNumber value="${goodsDto.deliveryPrice}"/>원</span></li>
                                <li><span>적립포인트</span> <span><fmt:formatNumber value="${goodsDto.point * orderGoodsQty}"/>P</span></li>
                            </ul>
                            <ul class="order-details-form mb-4">
                            	<c:set var="paymentAmt" value="${(goodsDto.price - (goodsDto.price * goodsDto.discountRate / 100)) * orderGoodsQty + goodsDto.deliveryPrice}"/>
                                    <li>총 결제금액<span><fmt:formatNumber value="${paymentAmt }"/>원</span></li>
                            </ul>
