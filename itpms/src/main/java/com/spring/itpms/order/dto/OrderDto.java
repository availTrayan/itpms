package com.spring.itpms.order.dto;
...
public class OrderDto {
	...
	public String toString() {
		return "OrderDto [orderCd=" + orderCd + ", memberId=" + memberId + ", goodsCd=" + goodsCd + ", orderGoodsQty="
				...
				+ ", receiverNm=" + receiverNm + ", receiverHp=" + receiverHp + ", postalcode=" + postalcode
				+ ", roadAddress=" + roadAddress + ", jibunAddress=" + jibunAddress + ", restAddress=" + restAddress
