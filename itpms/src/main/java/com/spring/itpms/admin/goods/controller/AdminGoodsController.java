package com.spring.itpms.admin.goods.controller;
...
import com.spring.itpms.admin.goods.service.AdminGoodsService;
...
public class AdminGoodsController {
	...
	//private final String SEPERATOR = "\\";											// windows
	...
	public ResponseEntity<Object> addNewGoods(MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		goodsDto.setCompany(multipartRequest.getParameter("company"));
		...
		goodsDto.setCategory(multipartRequest.getParameter("category"));
		goodsDto.setGoodsSpec(multipartRequest.getParameter("goodsSpec"));
	...
	public void goodsExcelExport(HttpServletResponse response , @RequestParam Map<String, String> dateMap) throws Exception {
		...
		for (GoodsDto goodsDto :  adminGoodsService.getGoodsList()) {
	        ...
	        cell = row.createCell(2);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue(goodsDto.getCategory());
	        cell = row.createCell(3);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue(goodsDto.getCompany());
	        cell = row.createCell(4);
	        cell.setCellStyle(bodyStyle);
